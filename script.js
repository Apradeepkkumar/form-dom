...
heading_h3.innerHTML = "HTML Form is a document which stores information of a user on a web server using interactive controls."
...
var fname = createFormElements('First Name', 'text', 'first-name', 'input');
var lname = createFormElements('Last Name ', 'text', 'last-name', 'input');
...
function createMultiSelect() {
    ...
    var opt1 = new Option('Biryani😍', 'Biryani😍');
    var opt2 = new Option('Porotta😋', 'Porotta😋');
    var opt3 = new Option('Dosai😊', 'Dosai😊');
    var opt4 = new Option('FullMeals❤️', 'FullMeals❤️');
